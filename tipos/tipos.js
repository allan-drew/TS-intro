...
let qualquerCoisa = ["Brasil", "Argentina"];
...
let dadosPessoa = ['Thiago Adriano', 34, 'tadriano.net@gmail.com'];
...
(function (Cor) {
    ...
    Cor[Cor["Prata"] = 101] = "Prata"; // now, Prata is 101
})(Cor || (Cor = {}));
let corCarro = Cor.Azul;
console.log(corCarro); // 1 
let corCarro2 = Cor.Prata;
